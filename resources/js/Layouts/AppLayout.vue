                                ...
                                <dropdown align="right" width="48">
                                    <template #trigger>
                                        <div class="pt-2 relative mx-auto text-gray-600">
                                            <input type="search" v-model="search" @keyup="userSearch" class="border-2 border-gray-300 bg-white w-100 h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" placeholder="Buscar un amigo...">
                                    ...
                                    <template #content>
                                       ...
                                       <div v-if="search == ''" >
                                           <span class="font-light text-gray-400 text-sm">Buscar amigos...</span>
                                        </div>
                                        <div v-if="!userExist && search != ''" >
                                           <span class="font-light text-gray-400 text-sm">No hay resultados</span>
                                        </div>
                                    </template>
                                </dropdown>
                            </div>
